...
from voicevox_engine.dev.synthesis_engine.mock import MockSynthesisEngine, create_phoneme_list
from voicevox_engine.full_context_label import Phoneme


class TestAccent2contextLabel(TestCase):

    mock_engine = MockSynthesisEngine(speakers=mock_metas(), supported_devices=mock_supported_devices())
