...
class Test_gen(TestCase):
    def test_fcl(self):
        ...
        for (i, _) in enumerate(base_label):
            ...
            # self.assertEqual(regen[i].contexts["e1"], base_label[i].contexts["e1"])
            # self.assertEqual(regen[i].contexts["e2"], base_label[i].contexts["e2"])
            # self.assertEqual(regen[i].contexts["e3"], base_label[i].contexts["e3"])
            # self.assertEqual(regen[i].contexts["e4"], base_label[i].contexts["e4"])
            # self.assertEqual(regen[i].contexts["e5"], base_label[i].contexts["e5"])
